import"./modulepreload-polyfill-3cfb730f.js";document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector("#proceed-to-payment");t&&t.addEventListener("click",o=>{o.preventDefault();const r=document.querySelector("#email").value.trim(),e=document.querySelector("#discord").value.trim(),n=document.querySelector("#fortniteusername").value.trim();if(!r||!e||!n){alert("Please fill in all the required fields.");return}alert("Processing your payment..."),setTimeout(()=>{alert("Your payment was successful! Thank you for your purchase."),window.location.href="/thank-you"},2e3)})});document.addEventListener("DOMContentLoaded",()=>{let t=JSON.parse(localStorage.getItem("carrito"))||[];function o(){const r=document.getElementById("cart-items-container");if(r.innerHTML="",t.length===0){r.innerHTML="<p>No items in cart.</p>";return}t.forEach(e=>{const n=document.createElement("div");n.classList.add("flex","items-center","justify-between","mb-4"),n.innerHTML=`
